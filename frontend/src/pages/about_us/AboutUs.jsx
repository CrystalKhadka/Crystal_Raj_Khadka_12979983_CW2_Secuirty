      ...
      <div className="about-us-container mt-5">
        ...
        <section className="about-us-content">
          <div className="about-us-intro">
            <h2>Our Story</h2>
            <p>
              Founded in 2020, Coldfilms has quickly become the go-to platform
          ...
          <div className="about-us-mission">
            <h2>Our Mission</h2>
            <p>
              At Coldfilms, we're on a mission to revolutionize the way you
        ...
        <section className="about-us-cta">
          <h2>Ready to Experience Coldfilms?</h2>
          <p>
            Join millions of movie lovers and book your next cinema adventure
            with us!
          </p>
          <Link to="/homepage" className="cta-button">
            Book Now
          </Link>
        </section>
      </div>
